package Tema_7_Ejercicios_Ampliacion.Ejercicio_1;
...
public class FechaClase {
    ...
    public FechaClase(DiaSemana dias, int dia, int mes, int año) {
        this.dias = dias;
        this.dia = dia;
        this.mes = mes;
        this.año = año;
    ...
    public FechaClase diaSiguiente(){
        ...
        return new FechaClase(dias, dia, mes, año);
    ...
    public boolean menor(FechaClase otraFecha) {
    ...
    public boolean mayor(FechaClase otraFecha) {
        if (this.año > otraFecha.getAño()) {
            return true;
        } else if (this.año < otraFecha.getAño()) {
            return false;
    ...
    public boolean igual(FechaClase otraFecha){
